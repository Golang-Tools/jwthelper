...
func WithAud(aud ...string) optparams.Option[SignOptions] {
	return optparams.NewFuncOption(func(o *SignOptions) {
		o.Aud = mergeStringSlice(o.Aud, aud)
	})
}

// AddAud 添加一个接收jwt的一方标识
func AddAud(aud string) optparams.Option[SignOptions] {
	return optparams.NewFuncOption(func(o *SignOptions) {
		o.Aud = mergeStringSlice(o.Aud, []string{aud})
	})
}

// mergeStringSlice 合并两个字符串切片并去重,保留原有顺序与新增项的顺序。
func mergeStringSlice(current []string, incoming []string) []string {
